...
class Array //using class to implement array as ADT
{
    ...
    public:
        ...
        void findMultipleMissingElementsHashing()
        {
            cout << "<----------------Finding missing elements using hashing---------------->" << endl;
            Array H;
            for(int i = 0; i < numberOfElements; i++) H.A[A[i]]++;
            for(int i = A[0]; i <= A[numberOfElements]; i++)
            {
                if(H.A[i] == 0) cout << "Missing: " << i << endl;
            }
        }
};
...
int main()
{
    ...
    while(flag)
    {
        ...
        << "25 - Find multiple missing elements using hashing" << endl;
        ...
        switch(choice)
        {
            ...
            case 24:
                ...
                break;
            case 25:
                array1.findMultipleMissingElementsHashing();
            default:
